...
func TestFloat(t *testing.T) {
	var cases = []struct {
		...
		{Value: 1.5, Expected: []byte{0xf9, 0x3e, 0x00}},
		{Value: 65504, Expected: []byte{0xf9, 0x7b, 0xff}},
		{Value: 100000.0, Expected: []byte{0xfa, 0x47, 0xc3, 0x50, 0x00}},
		{Value: 3.4028234663852886e+38, Expected: []byte{0xfa, 0x7f, 0x7f, 0xff, 0xff}},
		{Value: 1.0e+300, Expected: []byte{0xfb, 0x7e, 0x37, 0xe4, 0x3c, 0x88, 0x00, 0x75, 0x9c}},
		{Value: 5.960464477539063e-8, Expected: []byte{0xf9, 0x00, 0x01}},
		{Value: 0.00006103515625, Expected: []byte{0xf9, 0x04, 0x00}},
		{Value: -4.0, Expected: []byte{0xf9, 0xc4, 0x00}},
		{Value: -4.1, Expected: []byte{0xfb, 0xc0, 0x10, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66}},
